...
To intercept static binaries Firebuild requires a Qemu version that supports the -libc-syscall option. Prebuilt qemu-user packages are available from [our PPA](https://launchpad.net/~firebuild/+archive/ubuntu/qemu-backports):
...
If you have qemu-user installed you also need a version that supports the -libc-s option:
